...
format-check:
	$(PYTHON) -m black --check core/env.py core/logging_config.py core/test_settings.py run.py vocab/tasks.py vocab/tts.py vocab/utils.py tests/test_telegram_auth.py tests/test_progress_read_model.py tests/test_streaks.py tests/test_utils.py
